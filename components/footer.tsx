...
export default function Footer() {
  return (
    <footer className="bg-background border-t border-purple-500/20 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        <div className="flex justify-center space-x-6 md:order-2">
          ...
          >
            ...
            <div className="absolute -inset-2 bg-purple-500/20 scale-0 group-hover:scale-100 rounded-full blur-md transition-all duration-300"></div>
            <svg className="h-6 w-6 relative" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fillRule="evenodd"
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <p className="text-center text-xs leading-5 text-gray-400">
            &copy; {new Date().getFullYear()} Nuqta AI. All rights reserved.
          </p>
          <p className="text-center text-xs leading-5 text-gray-400 mt-1">
            <span className="hover:text-purple-400 transition-colors duration-300">Contact: 00968 71552969</span>
          </p>
        </div>
      </div>
    </footer>
